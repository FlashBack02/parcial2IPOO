...
class Partido{
 ...
 public function setObjEquipo2($objEquipo2){
    ...
    //Implementación darEquipoGanador
    ...
    public function calcularCoeficiente() {
        // Calcular el coeficiente multiplicando el coeficiente base por la cantidad de goles y la cantidad de jugadores
        return $this->getCoefBase() * $this->getCantGolesE1() * ($this->getObjEquipo1()->getCantJugadores() + $this->getObjEquipo2()->getCantJugadores());
    }
